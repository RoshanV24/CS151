...
public class Connection
{
   ...
   */
   public void dial(String key)
   {
      if (state == CONNECTED)
         connect(key);
      else if (state == RECORDING || state == ENTER_MAILBOX)
         login(key);
   ...
   */
   ...
   public void setInitialInputSet(Boolean x){
	   initialInputSet = x;
   }
   
   public Boolean getInitialInputSet(){
	   return initialInputSet;
   }
   
   public Boolean getAfterReset(){
	   return afterReset;
   }
   
   public void setAfterReset(Boolean state){
	   afterReset = state;
   }
   ...
   */
   private void resetConnection()
   {
      ...
      phone.speak(RESET_OPTION_PROMPT);
   }
   ...
   */
   ...
   private Boolean initialInputSet = false;
   ...
   private static final int ENTER_MAILBOX = 7;

   private static final String RESET_OPTION_PROMPT = "To leave a message, press (1), to access your mailbox, press (2)";
